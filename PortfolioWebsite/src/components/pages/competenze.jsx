            ...
            <div className="row my-xl-0 my-5">
                <div id='leftCol' className={`col-xl-6 mb-xl-0 mb-4 py-xl-3 ${ScreenSizeLg ? "" : "left-col-hidden"}`}>
                    ...
                    <p className="fs-5 fw-normal mb-3">
                        ...
                        <span className="fw-medium"> HTML5, CSS3, JavaScript, JQuery, PHP </span> 
                        e framework come <span className="fw-medium">Bootstrap</span> e 
                        <span className="fw-medium"> React</span>.
                    </p>
                    <p className='fs-5 fw-normal mb-3'> 
                        ...
                        <span className="fw-medium fst-italic"> ECDL Core</span>, che mi ha fornito una solida base 
                        nell'uso degli strumenti informatici più comuni, e ho seguito il corso 
                        <span className="fw-medium fst-italic"> Cisco IT Essentials 6.0</span>, grazie al quale ho 
                    ...
                    <p className="fs-5 fw-normal">
                        ...
                        ottenendo il <span className="fw-medium fst-italic">First Certificate in English (B2)</span>, che 
